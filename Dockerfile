...
RUN git clone --depth=1 --branch=18.0 https://github.com/jorge-luis-dev/DismeWeb.git /mnt/extra-addons
# RUN cd /mnt/extra-addons && pip3 install -r requirements.txt
